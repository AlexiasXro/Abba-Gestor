                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover mb-0">
                           <tbody>
                            <tr>
                                <th>Código</th>
                                <td><div id="qrcode-show {{ $producto->codigo }}">
    <p class="mb-0 text-muted small">{{ $producto->codigo }}</p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card shadow-sm border-1 rounded-2 p-2 h-100">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover text-center mb-0" style="font-size: 0.85rem;">
