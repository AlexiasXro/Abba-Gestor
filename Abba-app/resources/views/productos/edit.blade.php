...
@section('content')
    ...
    <div class="container">
        ...
        <form action="{{ route('productos.update', $producto) }}" method="POST">
            ...
            <div class="mb-3">
                <label for="stock_minimo" class="form-label">Stock mínimo <small
            ...
            @foreach ($talles as $talle)
                ...
                <div class="row mb-2 align-items-center">
                    ...
                    <div class="col-4">
                        ...
                        <input type="number" name="talles[{{ $loop->index }}][stock]" class="form-control" min="0"
                            value="{{ old('talles.' . $loop->index . '.stock', $stock) }}">
                    </div>
                </div>
            @endforeach
