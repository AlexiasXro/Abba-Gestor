    ...
    <form method="GET" action="{{ route('clientes.historial') }}" class="mb-4">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-3">
                ...
                <input type="text" name="numero_venta" value="{{ $filtros['numero_venta'] ?? '' }}" class="form-control" />
            </div>
            ...
            <div class="col-md-3">
                ...
                <select name="estado" class="form-select">
                    ...
                    <option value="pagado" {{ (isset($filtros['estado']) && $filtros['estado'] == 'pagado') ? 'selected' : '' }}>Pagado</option>
                    <option value="pendiente" {{ (isset($filtros['estado']) && $filtros['estado'] == 'pendiente') ? 'selected' : '' }}>Pendiente</option>
                    <option value="anulado" {{ (isset($filtros['estado']) && $filtros['estado'] == 'anulado') ? 'selected' : '' }}>Anulado</option>
                </select>
            </div>
            ...
            <div class="col-md-3">
                ...
                <input type="number" name="monto_min" value="{{ $filtros['monto_min'] ?? '' }}" step="0.01" class="form-control" />
            </div>

            <div class="col-md-3">
                <label>Monto máximo</label>
                <input type="number" name="monto_max" value="{{ $filtros['monto_max'] ?? '' }}" step="0.01" class="form-control" />
            </div>
