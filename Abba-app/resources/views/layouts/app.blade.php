...
<body>
    ...
    <ul class="dropdown-menu custom-hover">
        ...
        <li><a class="dropdown-item" href="{{ route('reportes.index') }}"><i class="bi bi-bar-chart-fill me-1"></i> Reportes</a></li>
        ...
        <li><a class="dropdown-item" href="{{ route('cierres.create') }}">Nuevo cierre</a></li>
         <li><hr class="dropdown-divider" /></li>
        <li><a class="dropdown-item" href="{{ route('configuracion.margenes') }}">Márgenes de Precios</a></li>
    </ul>
</li>
